jQuery("#simulation")
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-091cc84b-a486-4973-9ed9-fec9d2aa5e50 #s-Circle_1 svg" ],
                    "attributes": {
                      "path-background-color": "#1EAAF1"
                    }
                  } ],
              ...
              "actions": [
                ...
                },
                {
                  ...
                  "parameter": {
                    ...
                    "value": "Cerca del centro de la ciudad, de Triunfo, así como del Campus Fuentenueva de la Universidad de Granada."
                  },
                  "exectype": "serial",
                  "delay": 0
                }
          ...
          "blocks": [
            {
              "actions": [
                ...
                },
                {
                  ...
                  "#s-091cc84b-a486-4973-9ed9-fec9d2aa5e50 #s-Path_12 svg" ],
                    "attributes": {
                      "path-stroke": "#49454F"
                    }
                  } ],
                ...
                },
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-091cc84b-a486-4973-9ed9-fec9d2aa5e50 #s-Path_7 svg",
                ...
                },
                {
                  ...
                  "#s-091cc84b-a486-4973-9ed9-fec9d2aa5e50 #s-Paragraph_4 span" ],
                    "attributes": {
                      "color": "#49454F",
  ...
  .on("taphold", ".s-091cc84b-a486-4973-9ed9-fec9d2aa5e50 .taphold", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Path_28")) {
      cases = [
        {
          "blocks": [
            {
